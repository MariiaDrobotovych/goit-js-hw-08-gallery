...
const createImageTag = image => {
  const galleryItemsRef = document.createElement('li');
  galleryItemsRef.classList.add('gallery__item');
  ...
  galleryItemsRef.appendChild(linkRef);
  return galleryItemsRef;
}
...
const galleryCard = images.map(image => createImageTag(image));
